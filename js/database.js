...
const mocasines40 = new Producto("Boedo", "Redragon", "Mocasines", 41, "Blanco", 11500);
const mocasines43 = new Producto("Boedo", "Verano", "Mocasines", 41, "Marron", 11500);
const mocasines44 = new Producto("Boedo", "Running", "Mocasines", 41, "Negro", 11500);
